...
.policy-center__search { display:flex; align-items:center; gap:8px; min-width:260px; padding:10px 12px; border:1px solid var(--color-line); border-radius:10px; background:#fff; }.policy-center__search input { border:0; outline:0; width:100%; }
.policy-center__categories { display:grid; grid-template-columns:repeat(auto-fit, minmax(190px, 1fr)); gap:14px; margin-bottom:22px; }.policy-center__category { display:grid; gap:5px; padding:18px; background:#fff; border:1px solid var(--color-line); border-radius:12px; }.policy-center__category span { color:var(--color-primary); }.policy-center__category small { color:var(--color-muted); }
.policy-center__documents { padding:20px; border:1px solid var(--color-line); border-radius:12px; background:#fff; }.policy-center__documents-header { display:flex; justify-content:space-between; align-items:center; border-bottom:1px solid var(--color-line); }.policy-center__documents-header h3 { margin:0 0 14px; }.policy-center__documents-header span { color:var(--color-muted); font-size:13px; }
