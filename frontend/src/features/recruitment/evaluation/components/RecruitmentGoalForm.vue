...
<style scoped>
.goal-form { display:grid; gap:18px; padding:22px; border:1px solid var(--color-line); border-radius:var(--radius-md); background:#fff; box-shadow:var(--shadow-card); }
...
.goal-form__errors { margin:0; padding:12px 28px; border-radius:var(--radius-sm); background:#fff7f7; color:#b91c1c; }.goal-form button { min-height:44px; border-radius:var(--radius-sm); background:var(--color-primary); color:#fff; font-weight:800; }.goal-form button:disabled { opacity:.6; cursor:wait; }
