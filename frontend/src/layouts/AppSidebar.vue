...
.sidebar { position: fixed; top: var(--topbar-height); bottom: 0; left: 0; z-index: 15; display: flex; width: var(--sidebar-width); flex-direction: column; justify-content: space-between; padding: 22px 16px; border-right: 1px solid var(--color-line); background: var(--color-surface); backdrop-filter: blur(14px); }.sidebar__groups { display: grid; gap: 22px; }.sidebar__group h2 { margin: 0 0 9px 10px; color: var(--color-subtle); font-size: 12px; font-weight: 800; }.sidebar__item { display:flex; width:100%; align-items:center; gap:10px; padding:11px 12px; border-radius:var(--radius-sm); background:transparent; color:var(--color-muted); text-align:left; }.sidebar__item-mark { width:8px; height:8px; border:2px solid currentColor; border-radius:50%; }.sidebar__item--active { background:var(--color-primary-soft); color:var(--color-primary); font-weight:800; }.sidebar__profile { display:flex; align-items:center; gap:10px; padding:12px; border:1px solid var(--color-line); border-radius:var(--radius-md); background:var(--color-surface); }.sidebar__avatar { display:grid; width:40px; height:40px; place-items:center; border-radius:50%; background:var(--color-primary-soft); color:var(--color-primary); font-weight:800; }.sidebar__profile strong,.sidebar__profile small { display:block; }.sidebar__profile small { margin-top:3px; color:var(--color-muted); font-size:12px; } @media (max-width:980px) { .sidebar { position:static; width:auto; padding:12px 18px; }.sidebar__groups { grid-template-columns:repeat(3,minmax(0,1fr)); }.sidebar__profile { display:none; } }
</style>
